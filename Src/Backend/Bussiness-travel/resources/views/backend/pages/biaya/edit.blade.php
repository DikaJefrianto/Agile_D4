            ...
            <form action="{{ route('admin.biaya.update', $biaya->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                   ...
                   dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                        <option value="" disabled {{ old('kategori', $kategori) ? '' : 'selected' }}>
                            -- Pilih Kategori --
                        </option>
                ...
                <div>
                    ...
                    <input type="text" name="jenisKendaraan" id="jenisKendaraan"
                        value="{{ old('jenisKendaraan', $biaya->jenisKendaraan) }}" required maxlength="255"
                ...
                <div>
                    ...
                    <input type="factorEmisi" step="0.0001" name="factorEmisi" id="factorEmisi"
                        value="{{ old('factorEmisi', $biaya->factorEmisi) }}" required

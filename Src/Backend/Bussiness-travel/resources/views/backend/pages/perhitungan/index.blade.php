                        ...
                        <tbody>
                            @forelse($perhitungan as $item)
                                <tr class="border-b border-gray-100 dark:border-gray-800">
                                    ...
                                    <td class="px-5 py-4 sm:px-6">{{ __(ucfirst($item->kategori)) }}</td>{{-- Assuming kategori might not always be directly translatable, but if it is, consider __($item->kategori) --}}
                                    <td class="px-5 py-4 sm:px-6">
                                    ...
                                    <td class="px-5 py-4 sm:px-6 flex gap-2">
                                        <a href="{{ route('admin.perhitungan.edit', $item) }}" class="btn-default !p-2">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="{{ route('admin.perhitungan.show', $item->id) }}" class="btn-default !p-2" title="{{ __('Lihat Detail') }}">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        ...
                                        {{-- <form action="{{ route('admin.perhitungan.destroy', $item->id) }}" method="POST"
                                            onsubmit="return confirm('{{ __('Yakin ingin menghapus data ini?') }}')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn-danger !p-2" title="Hapus">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                        </form> --}}
                                    </td>

...
<div id="json-modal-<?php echo e($log->id); ?>"
    ...
    <div class="relative p-4 w-full max-w-4xl bg-white rounded-lg shadow-lg dark:bg-gray-700 z-60">
        ...
        <button type="button"
            ...
            data-modal-hide="json-modal-<?php echo e($log->id); ?>">
        ...
        <!-- Modal Content -->
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4"><?php echo e(__('Action Log Data')); ?></h3>

        <!-- Display pretty-printed JSON data -->
        <div class="space-y-3">
            <pre class="bg-gray-100 p-4 rounded-md text-gray-800 dark:text-white dark:bg-gray-800">
                <?php echo e(json_encode(json_decode($log->data), JSON_PRETTY_PRINT)); ?>

            </pre>
        </div>
    </div>
</div>
<?php /**PATH /Users/maniruzzamanakash/workspace/laravel-role/resources/views/backend/pages/action-logs/partials/detail-modal.blade.php ENDPATH**/ ?>
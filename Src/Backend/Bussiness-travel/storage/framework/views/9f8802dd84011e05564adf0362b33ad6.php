    ...
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <div x-data="{ pageName: <?php echo e(__('Action Logs')); ?> }">
            <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90"><?php echo e(__('Action Logs')); ?></h2>
                <nav>
                    <ol class="flex items-center gap-1.5">
                        ...
                        <li class="text-sm text-gray-800 dark:text-white/90"><?php echo e(__('Action Logs')); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <table id="actionLogsTable" class="w-full dark:text-gray-400">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $actionLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <td class="px-5 py-4 sm:px-6 text-left"><?php echo e(__(ucfirst($log->type))); ?></td>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/maniruzzamanakash/workspace/laravel-role/resources/views/backend/pages/action-logs/index.blade.php ENDPATH**/ ?>
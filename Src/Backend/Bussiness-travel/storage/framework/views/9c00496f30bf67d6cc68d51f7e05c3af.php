...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] mt-4">
    ...
    <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                    <?php echo e(__('Theme Primary Color')); ?>

                </label>
                <div class="flex gap-2 items-center">
                    <div>
                        <input type="color" id="color-picker-theme_primary_color" name="theme_primary_color"
                            value="<?php echo e(config('settings.theme_primary_color') ?? ''); ?>"
                        ...
                        <div id="tooltip-theme_primary_color" role="tooltip"
                            ...
                            <?php echo e(__('Choose color')); ?>

                            <div class="tooltip-arrow" data-popper-arrow></div>
                        </div>
                    </div>
                    <input type="text" id="input-theme_primary_color" name="theme_primary_color_text"
                        value="<?php echo e(config('settings.theme_primary_color') ?? '#ffffff'); ?>"
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                    <?php echo e(__('Theme Secondary Color')); ?>

                </label>
                <div class="flex gap-2 items-center">
                    <div>
                        <input type="color" id="color-picker-theme_secondary_color" name="theme_secondary_color"
                            value="<?php echo e(config('settings.theme_secondary_color') ?? ''); ?>"
                            class="h-11 w-11 cursor-pointer dark:border-gray-700"
                    ...
                    <input type="text" id="input-theme_secondary_color" name="theme_secondary_color_text"
                        value="<?php echo e(config('settings.theme_secondary_color') ?? '#ffffff'); ?>"
                        class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
        ...
        <div class="flex">
            <div class="md:basis-1/2">
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                    <?php echo e(__('Default Mode')); ?>

                </label>
                <select name="default_mode"
                    class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                    <option value="lite" <?php echo e(config('settings.default_mode') == 'lite' ? 'selected' : ''); ?>><?php echo e(__('Lite')); ?>

                    </option>
                    <option value="dark"<?php echo e(config('settings.default_mode') == 'dark' ? 'selected' : ''); ?>><?php echo e(__('Dark')); ?>

                    </option>
                    <option value="system"<?php echo e(config('settings.default_mode') == 'system' ? 'selected' : ''); ?>><?php echo e(__('System')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <!-- Lite Mode Colors -->
            <div>
                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-400 mb-4"><?php echo e(__('Lite Mode Colors')); ?></h4>

                <!-- Navbar Background Color (Lite Mode) -->
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                        <?php echo e(__('Navbar Background Color')); ?>

                    </label>
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-navbar_bg_lite" name="navbar_bg_lite"
                                value="<?php echo e(config('settings.navbar_bg_lite') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-navbar_bg_lite" name="navbar_bg_lite_text"
                            value="<?php echo e(config('settings.navbar_bg_lite') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                        <?php echo e(__('Sidebar Background Color')); ?>

                    </label>
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-sidebar_bg_lite" name="sidebar_bg_lite"
                                value="<?php echo e(config('settings.sidebar_bg_lite') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-sidebar_bg_lite" name="sidebar_bg_lite_text"
                            value="<?php echo e(config('settings.sidebar_bg_lite') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                        <?php echo e(__('Navbar Text Color')); ?>

                    </label>
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-navbar_text_lite" name="navbar_text_lite"
                                value="<?php echo e(config('settings.navbar_text_lite') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-navbar_text_lite" name="navbar_text_lite_text"
                            value="<?php echo e(config('settings.navbar_text_lite') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                        <?php echo e(__('Sidebar Text Color')); ?>

                    </label>
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-sidebar_text_lite" name="sidebar_text_lite"
                                value="<?php echo e(config('settings.sidebar_text_lite') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-sidebar_text_lite" name="sidebar_text_lite_text"
                            value="<?php echo e(config('settings.sidebar_text_lite') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
            ...
            <!-- Dark Mode Colors -->
            <div>
                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-400 mb-4"><?php echo e(__('Dark Mode Colors')); ?></h4>
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-navbar_bg_dark" name="navbar_bg_dark"
                                value="<?php echo e(config('settings.navbar_bg_dark') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-navbar_bg_dark" name="navbar_bg_dark_text"
                            value="<?php echo e(config('settings.navbar_bg_dark') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-sidebar_bg_dark" name="sidebar_bg_dark"
                                value="<?php echo e(config('settings.sidebar_bg_dark') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-sidebar_bg_dark" name="sidebar_bg_dark_text"
                            value="<?php echo e(config('settings.sidebar_bg_dark') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-navbar_text_dark" name="navbar_text_dark"
                                value="<?php echo e(config('settings.navbar_text_dark') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-navbar_text_dark" name="navbar_text_dark_text"
                            value="<?php echo e(config('settings.navbar_text_dark') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                    ...
                    <div class="flex gap-2 items-center">
                        <div>
                            <input type="color" id="color-picker-sidebar_text_dark" name="sidebar_text_dark"
                                value="<?php echo e(config('settings.sidebar_text_dark') ?? ''); ?>"
                                class="h-11 w-11 cursor-pointer dark:border-gray-700"
                        ...
                        <input type="text" id="input-sidebar_text_dark" name="sidebar_text_dark_text"
                            value="<?php echo e(config('settings.sidebar_text_dark') ?? '#ffffff'); ?>"
                            class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
    ...
    <?php echo ld_apply_filters('settings_appearance_tab_before_section_end', '') ?>
</div>
<?php echo ld_apply_filters('settings_appearance_tab_after_section_end', '') ?>

<!-- Custom CSS & JS Section -->
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] mt-4">
    <div class="px-5 py-4 sm:px-6 sm:py-5">
        <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
            <?php echo e(__('Custom CSS & JavaScript')); ?>
    ...
    <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                <?php echo e(__('Global Custom CSS')); ?>
            ...
            <textarea name="global_custom_css" rows="6"
                ...
                placeholder=".my-class { color: red; }"><?php echo e(config('settings.global_custom_css')); ?></textarea>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                <?php echo e(__('Add custom CSS that will be applied to all pages')); ?>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-1">
                <?php echo e(__('Global Custom JavaScript')); ?>

            </label>
            <textarea name="global_custom_js" rows="6"
                class="w-full rounded-lg border border-gray-300 bg-transparent p-4 text-sm text-gray-800 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90"
                placeholder="document.addEventListener('DOMContentLoaded', function() { /* Your code */ });"><?php echo e(config('settings.global_custom_js')); ?></textarea>
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                <?php echo e(__('Add custom JavaScript that will be loaded on all pages')); ?>
...
<?php /**PATH F:\Project\Agile_D4\Src\Backend\Bussiness-travel\resources\views/backend/pages/settings/appearance-tab.blade.php ENDPATH**/ ?>
...
<div class="rounded-xl shadow-sm p-4 py-6 z-1 dark:bg-slate-800">
            ...
            <div class="relative">
                ...
                <div id="dropdown"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>?chart_filter_period=last_12_Months"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white <?php echo e($currentFilter === 'last_12_months' ? 'bg-blue-100 dark:bg-gray-600' : ''); ?>">
                                <span class="ml-2"> <?php echo e(__('Last 12 months')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>?chart_filter_period=this_year"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white <?php echo e($currentFilter === 'this_year' ? 'bg-blue-100 dark:bg-gray-600' : ''); ?>">
                                <span class="ml-2"> <?php echo e(__('This year')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>?chart_filter_period=last_year"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white <?php echo e($currentFilter === 'last_year' ? 'bg-blue-100 dark:bg-gray-600' : ''); ?>">
                                <span class="ml-2"> <?php echo e(__('Last year')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>?chart_filter_period=last_30_days"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white <?php echo e($currentFilter === 'last_30_days' ? 'bg-blue-100 dark:bg-gray-600' : ''); ?>">
                                <span class="ml-2"> <?php echo e(__('Last 30 days')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>?chart_filter_period=last_7_days"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white <?php echo e($currentFilter === 'last_7_days' ? 'bg-blue-100 dark:bg-gray-600' : ''); ?>">
                                <span class="ml-2"> <?php echo e(__('Last 7 days')); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('admin.dashboard')); ?>?chart_filter_period=this_month"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white <?php echo e($currentFilter === 'this_month' ? 'bg-blue-100 dark:bg-gray-600' : ''); ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const currentFilter = "<?php echo e($currentFilter); ?>";
...
<?php /**PATH F:\Project\Agile_D4\Src\Backend\Bussiness-travel\resources\views/backend/pages/dashboard/partials/user-growth.blade.php ENDPATH**/ ?>
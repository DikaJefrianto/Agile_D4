...
<div class="w-full bg-white rounded-xl shadow-sm dark:bg-slate-800 p-4 ">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const newUsers = <?php echo json_encode($newUsers ?? 0, 15, 512) ?>;
            const oldUsers = <?php echo json_encode($oldUsers ?? 0, 15, 512) ?>;
...
<?php /**PATH /Users/maniruzzamanakash/workspace/laravel-role/resources/views/backend/pages/dashboard/user-pie-chart.blade.php ENDPATH**/ ?>
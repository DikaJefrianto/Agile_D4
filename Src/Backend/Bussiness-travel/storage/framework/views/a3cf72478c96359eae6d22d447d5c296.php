        ...
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <nav>
                <ol class="flex items-center gap-1.5">
                    ...
                    <li class="text-sm text-gray-800 dark:text-white/90"><?php echo e(__('Modules')); ?></li>
                </ol>
            </nav>
        </div>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/maniruzzamanakash/workspace/laravel-role/resources/views/backend/pages/modules/index.blade.php ENDPATH**/ ?>
      ...
      <form action="<?php echo e(route('login')); ?>" method="POST">
        ...
        <div class="space-y-5">
          ...
          <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400"><?php echo e(__('Forgot password?')); ?></a>
          </div>
          <!-- Button -->
          <div>
...
<?php echo $__env->make('auth.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Project\Agile_D4\Src\Backend\Bussiness-travel\resources\views/auth/login.blade.php ENDPATH**/ ?>
                ...
                <tbody>
                    @forelse($bahan_bakars as $item)
                        <tr class="text-center">
                            ...
                            <td>
                                <a href="{{ route('BahanBakar.edit', $item->id) }}" class="btn btn-sm btn-warning me-1" title="Edit">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                                <form action="{{ route('BahanBakar.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')

    ...
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        ...
        <!-- Form untuk Tampilkan Daftar Strategi -->
        <div class="space-y-6">
            <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between items-center">
                    <h3 class="text-base font-medium text-gray-800 dark:text-white/90">{{ __('Strategi') }}</h3>

                    @include('backend.partials.search-form', [
                        'placeholder' => __('Search strategi'),
                    ])
                    @if (auth()->user()->can('strategi.create'))
                        <a href="{{ route('admin.strategis.create') }}" class="btn-success">
                            <i class="bi bi-plus-circle mr-2"></i>
                            {{ __('Tambah Strategi') }} <!-- Button Tambah Strtategi-->
                        </a>
                    @endif
                </div>

                <!-- Tabel daftar Strategi-->
                <div class="space-y-3 border-t border-gray-100 dark:border-gray-800 overflow-x-auto">
                    <table class="w-full dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-800"> <!--edit strategi-->

...
class AdminMenuService
{
    ...
    public function getMenu()
    {
        ...
        $this->addMenuItem([
            ...
            'active'      => Route::is('admin.strategi.*'),
            'priority'    => 25,
        ...
        $this->addMenuItem([
            ...
            'children'    => [
                [
                    ...
                    'active'      => Route::is('perusahaan.consultations.index') || Route::is('admin.strategis.edit'),
                    'priority'    => 10,
                    'permissions' => 'strategi.view',
                ],
                [
                    'label'       => __('Ajukan Konsultasi'),
                    'route'       => route('admin.consultations.create'),
                    'active'      => Route::is('admin.consultations.create'),
                    'priority'    => 20,
